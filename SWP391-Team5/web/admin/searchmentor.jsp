                        ...
                        <div class="attendance-list">
                                ...
                                <tbody>
                                    <c:forEach items="${listMentor}" var="o">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="updatestatusmentorsearch?idmentor=${o.id}&txtSearch=${searchValue}&stt=${o.stt}" class="btn btn-${o.activeStatusOfAdvisor == 1 ? 'success' : 'danger'} status-btn">
                                                    <c:choose>
                            ...
                            <div class="pagination-custom">
                                ...
                                <c:forEach begin="1" end="${numberPageSearcha}" var = "i">
                                    ...
                                    <a href="searchControl?index=${i}&txtSearch=${searchValue}" class="${indexPagee == i ?  "active" : ""}">${i}</a>
                                </c:forEach>
                            </div>
