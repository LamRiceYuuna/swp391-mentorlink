                ...
                <div class="card card_login divcenter noradius noborder allmargin modal-padding card-login-custom"
                    ...
                    <div class="card-body nopadding">
                        <div class="wrap-title">
                            <h3 class="title">Confirm Account</h3>
                        </div>
                        ...
                        <p class="mess"> The confirmation code is incorrect, click "Retry" to receive a new confirmation code!</p>
